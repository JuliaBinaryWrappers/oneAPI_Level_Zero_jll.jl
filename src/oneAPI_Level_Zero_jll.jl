...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import oneAPI_Level_Zero_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0038a6a5-a77d-50b4-8f67-3bd55e463950"))
platforms = [Pkg.Artifacts.unpack_platform(e, "oneAPI_Level_Zero", artifacts_toml) for e in artifacts["oneAPI_Level_Zero"]]
...
if best_platform === nothing
    @debug("Unable to load oneAPI_Level_Zero; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module oneAPI_Level_Zero_jll
